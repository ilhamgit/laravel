...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $widget['totalCategory'] = Category::count();
        $widget['totalLeague'] = League::count();
        $widget['totalMatch'] = Match::count();
        $widget['totalBet'] = Bet::count();
        ...
        $dbud_url="https://www.metahorse.site/admin/summary/";

        $ch = curl_init($dbud_url);
        ...
        $dbud_response = curl_exec($ch);

        $dboard_api=json_decode($dbud_response,1);


        return view('admin.dashboard', compact('pageTitle', 'widget', 'report', 'withdrawals', 'chart','payment','paymentWithdraw','depositsMonth','withdrawalMonth','months','deposits', 'dboard_api'));
    }
