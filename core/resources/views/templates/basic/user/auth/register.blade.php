        ...
        <div class="account-wrapper bg--section">
            <div class="inner">
                ...
                <form class="account-form row" action="{{ route('user.register') }}" method="POST" onsubmit="return submitUserForm();">
                    ...
                    <div class="cmn--form--group form-group col-12">
                        <label for="wallet" class="cmn--label text--white w-100">@lang('Wallet')</label>
                        <div class="input-group">
                            <span class="input-group-text">
                                <i class="las la-user"></i>
                            </span>
                            <input type="text" class="form-control form--control" name="wallet" value="@php echo $_GET['wlt']; @endphp" readonly>
                        </div>
                    </div>
