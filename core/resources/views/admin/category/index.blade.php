...
@section('panel')
                                ...
                                @forelse ($categories as $item)
                                    <tr>
                                        ...
                                        <td data-label="@lang('Action')">
                                            <button type="button" class="icon-btn cuModalBtn" data-resource="{{$item}}" data-modal_title="@lang('Update Regions')" data-has_status="1" title="@lang('Edit')"><i class="la la-pencil-alt"></i></button>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"> @lang('Add New Regions')</h5>
    ...
    <div class="d-flex flex-wrap justify-content-end flex-gap-8">
        ...
        <button type="button" class="btn btn--primary cuModalBtn" data-modal_title="@lang('Add Regions')"><i class="las la-plus"></i>@lang('Add New')</button>
