                    ...
                    <div class="table-responsive--sm table-responsive">
                        <table class="table table--light style--two">
                            <thead>
                                <tr>
                                    <th>@lang('SL')</th>
                                    <th>@lang('Race Track Distances')</th>
                                    <th>@lang('Country')</th>
                                    <th>@lang('Icon')</th>
                            ...
                            <tbody class="list">
                                @forelse ($leagues as $item)
                                    <tr>
                                        ...
                                        <td data-label="@lang('Race Track Distances')">{{__($item->name) }}</td>
                                        <td data-label="@lang('Country')">{{__($item->category->name) }}</td>
                ...
                <form action="{{route('admin.league.store')}}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label class="form-control-label font-weight-bold">@lang('Select Country') <span class="text-danger">*</span></label>
                        ...
                        <div class="form-group">
                            <label class="form-control-label font-weight-bold">@lang('Race Track Distances') <span class="text-danger">*</span></label>
