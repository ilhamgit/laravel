...
if(isset($dboard_api['totalDeposit'])){
    $tdeposit=$dboard_api['totalDeposit'];
    $twithdraw=$dboard_api['totalWithdrawal'];
    $pdeposit=$dboard_api['pendingDeposit'];
    $pwithdraw=$dboard_api['pendingWithdrawal'];
    $tbets=$dboard_api['totalBets'];
    $tmatches=$dboard_api['totalMatches'];

    $dp_y="[";

    foreach($dboard_api['deposits'] as $no => $ddata){

        $dp_x[]=$ddata['matchDate'];

        $dp_y.=$ddata['totalDeposit'].',';
    ...
    foreach($dboard_api['withdrawals'] as $no => $ddata){

        $wd_x[]=$ddata['matchDate'];

        $wd_y.=$ddata['totalWithdrawal'].',';
...
@section('panel')
        ...
        <div class="col-xl-12 mb-30">
            <div class="row mb-none-30">
                <div class="col-lg-6 col-sm-6 mb-30">
                    <div class="widget-three box--shadow2 b-radius--5 bg--green text-white">
                        <div class="widget-three__content">
                            <h2 class="numbers text-white">{{$tdeposit}} G</h2>
                            <p class="text--small">@lang('Total Deposited')</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-sm-6 mb-30">
                    <div class="widget-three box--shadow2 b-radius--5 bg--danger text-white">
                        <div class="widget-three__content">
                            <h2 class="numbers text-white">{{$twithdraw}} MTBTC</h2>
                ...
                <div class="col-lg-6 col-sm-6 mb-30">
                    <div class="widget-three box--shadow2 b-radius--5 bg--white">
                        ...
                        <div class="widget-three__content">
                            <h2 class="numbers">{{$pdeposit}} G</h2>
                ...
                <div class="col-lg-6 col-sm-6 mb-30">
                    <div class="widget-three box--shadow2 b-radius--5 bg--white">
                        ...
                        <div class="widget-three__content">
                            <h2 class="numbers">{{$pwithdraw}} MTBTC</h2>
    ...
    <div class="row mt-50 mb-none-30">
        ...
        <div class="col-xl-6 col-lg-6 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--18 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$tmatches}}</span>
                    </div>
                    <div class="desciption">
                        <span>@lang('Total Match')</span>
                    </div>

                    <a href="{{route('admin.match.index')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-6 col-lg-6 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--19 b-radius--10 box-shadow">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$tbets}}</span>
                    </div>
                    <div class="desciption">
                        <span>@lang('Total Bets')</span>
                    </div>
                    <a href="{{route('admin.bet.index')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row mb-none-30 mt-5">
        <div class="col-xl-6 mb-30">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">@lang('Last 7 Days Deposit History')</h5>
        ...
        <div class="col-xl-6 mb-30">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">@lang('Last 7 days Withdraw History')</h5>
...
@push('script')
    ...
    <script>
        ...
        var options = {
            ...
            xaxis: {
                categories: [@foreach($wd_x as $date)"{{$date}}",@endforeach]
            },
            grid: {
                padding: {
                    left: 5,
        ...
        chart.render();
         ...
         // apex-line chart
            var options = {
                ...
                xaxis: {
                    categories: [@foreach($dp_x as $date)"{{$date}}",@endforeach]
                },
                grid: {
                    padding: {
                        left: 5,
